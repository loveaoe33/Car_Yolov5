...
def run(
        ...
        source=ROOT / 'data/car_Images',  # file/dir/URL/glob/screen/0(webcam)
        ...
        project=ROOT / 'runs/detect/test',  # save results to project/name
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'data/car_Image', help='file/dir/URL/glob/screen/0(webcam)')
